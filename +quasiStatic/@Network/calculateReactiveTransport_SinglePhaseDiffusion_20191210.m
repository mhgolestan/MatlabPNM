% Single phase Reactive transport_Raoof_2017 fullyImplicit
function calculateReactiveTransport_SinglePhaseDiffusion(network, inletPressure, outletPressure, soluteConcentration, poreVolumeSimulation, poreVolumeInjected)
            ...
            while network.capillaryNumber > 10^(-7) || network.pecletNumber >= 1 % for Capillary dominant flow
...
%             timeStep = timeStep *10;
            ...
            % for quasi-static must be less than 10e-5
            ...
            network.pecletNumber = network.xDimension * network.velocity / diffusionCoefficent;
            end
            inletPressure
