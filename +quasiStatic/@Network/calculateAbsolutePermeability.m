...
obj.absolutePermeability = unitConvertor * obj.velocity * obj.xDimension / (inletPressure -outletPressure );
format longE
obj.absolutePermeability_m2 = obj.velocity * obj.xDimension / (inletPressure -outletPressure );
end
